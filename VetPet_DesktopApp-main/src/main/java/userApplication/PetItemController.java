...
//    }
    ...
    public void showPetStatusPage(Pet pet, String type) throws IOException {
        ...
        loader.load();
        userApplication.PetStatusPageController statusPageController = loader.getController();
        statusPageController.setData(pet,type);
        Stage stage = new Stage();
        pane = FXMLLoader.load(getClass().getResource("userApplication/petStatusPage.fxml"));
