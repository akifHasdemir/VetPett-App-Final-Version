...
import com.example.vetpetapp.Pet;
...
import vetApplication.VetProfileController;
...
//    }
    ...
    protected void addPet(){
        ...
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("userApplication/pet_item.fxml"));
...
//                    }
                    try {
                        ...
                        loader.setLocation(getClass().getResource("userApplication/petStatusPage.fxml"));
                        AnchorPane pane = loader.load();
                        PetStatusPageController statusPageController = loader.getController();
